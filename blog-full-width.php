      ...
      <div class="container"><!-- container -->
        <div class="row"><!-- row -->
          <div class="col-xs-12"><!-- col-xs-12 -->
            <h1 class="section-title text-center">all blog post</h1>
          </div><!-- /.col-xs-12 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /.blog-header -->
    ...
    <section class="blog-content"><!-- blog-content -->
      <div class="container"><!-- container -->
        <div class="row"> <!-- row -->
          ...
          <div class="wow zoomIn col-xs-12 col-sm-9 col-md-10"><!-- col-md-10 -->
    ...
    <section class="blog-content"><!-- blog-content -->
      <div class="container"> <!-- container -->
        <div class="row"> <!-- row -->
          ...
          <div class="wow zoomIn col-xs-12 col-sm-9 col-md-10">  <!-- col-xs-12 -->
            <h1><a href="#">This is a standard post format with Vimeo Video</a></h1>
            <div class="icon-holder"><!-- icon-holder -->
              <a href="#"><span><i class="flaticon-man494"></i> admin</span></a>
              <a href="#"><span><i class="flaticon-eye128"></i> views</span></a>
