  ...
  <section id="blog" class="blog-wrapper section-padding">
      ...
      <div class="row">
        ...
        <div class="wow zoomIn col-xs-12 col-md-4">
          ...
          <div class="blog-container">
            <h2><a href="blog-sidebar.php" target="_blank">The Green Fields of Spring</a></h2>
            <p>Tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam</p>
            <a class="custom-button" href="blog-sidebar.php" >read more <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
        <div class="wow zoomIn col-xs-12 col-md-4">
          ...
          <div class="blog-container">
            <h2><a href="blog-sidebar.php" target="_blank"> 10 Things you Need to Know</a></h2>
            <p>Tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam</p>
            <a class="custom-button" href="blog-sidebar.php" >read more <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
        <div class="wow zoomIn col-xs-12 col-md-4">
          ...
          <div class="blog-container">
            <h2><a href="blog-sidebar.php" target="_blank">The Secret Trick to Achieve</a></h2>
            <p>Tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam</p>
            <a class="custom-button" href="blog-sidebar.php" >read more <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
    ...
    <div class="more-area">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <h2 class="pull-left">Some headline can go here</h2>
            <button type="button" class="btn btn-success pull-right">click here</button>
          </div><!-- col-xs-12 -->
        </div><!-- row -->
      </div><!-- container -->
    </div><!-- /.more-area -->
